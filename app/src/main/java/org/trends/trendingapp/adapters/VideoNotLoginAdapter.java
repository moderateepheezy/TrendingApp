...
public class VideoNotLoginAdapter extends RecyclerView.Adapter<VideoNotLoginAdapter.ViewHolder> {
    private List<VideoCategoryInfo> mVideoCategoryInfo;
    private int itemLayout;
    public static Context context;

    public VideoNotLoginAdapter(Context contex, List<VideoCategoryInfo> log, int itemLayout) {
        context = contex;
