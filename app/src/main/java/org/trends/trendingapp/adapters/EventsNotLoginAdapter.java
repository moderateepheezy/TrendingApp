...
public class EventsNotLoginAdapter extends RealmBaseRecyclerViewAdapter<Datum, EventsNotLoginAdapter.PostsViewHolder> {
    ...
    public EventsNotLoginAdapter(Context context, RealmResults<Datum> realmResults, boolean automaticUpdate) {
