...
import org.trends.trendingapp.services.NewsAllAPIHelper;
 ...
 */
public class NewsAllFragment extends Fragment implements  TestNewsNotLoginAdapter.EventListener{
    ...
    public TestNewsNotLoginAdapter adapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        NewsAllAPIHelper.getPosts(getActivity());
    ...
    */
    private void initView(View v) {
        ...
        adapter = new TestNewsNotLoginAdapter(getActivity(), realmResults, true, user);
        adapter.setEventListener(this);
        recyclerView.setAdapter(adapter);
    }

    @Subscribe
    public void onPostSuccess(NewsAllAPIHelper.PostsInfoSuccess postInfo) {
        setRefreshing(false);
    }
    ...
    @Subscribe
    public void onPostFailure(NewsAllAPIHelper.PostsInfoFailure error) {
        setRefreshing(false);
