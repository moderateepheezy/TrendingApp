...
public class NewsAllAPIHelper {


    private static final String TAG = NewsAllAPIHelper.class.getSimpleName();

    public static void getPosts(final Context context) {

        RetrofitInterface retrofitInterface = BaseClient.getRetrofitInterface();
        retrofitInterface.getAllNews(new Callback<NewsTrendList>() {
            @Override
            public void success(NewsTrendList postsDataWrapper, Response response) {
                ...
                try {
                    ...
                    realm.delete(NewsTrendList.class);
                    realm.delete(NewsTrend.class);
